    	...
    	$.ajax({
    		...
    		success:function(msg){
    				$.each(msg,function(index,data1){
        				...
        				$("#part").append("<div class='order-hd'><span><i>订单编号：</i>"+data1.id+"</span><i>创建时间：</i>"+data1.time+"</div><div  class='order-bd clearfix'><div class='fl restaurant-msg'><div><img src='' alt='' width='43' height='43' class='fl' /><i class='fl'>"+data1.storename+"</i></div><p class='clearfix'><i class='fl'></i><span class='fl'>餐厅电话："+data1.storenumber+"</span></p></div><div class='fl order-total padding-margin'><p>订单金额</p><p><i>￥"+data1.money+"</i></p></div>  </div>");
        			})
    		}
    	})
    })
                    ...
                    <h1 class="fl">
                        ...
                        <ul class="member logging" ng-init="loginInfo=true">
                            ...
                            <li class="userName">
                                ...
                                <div>
                                    <p><a href="/memberIndex?logintoken=${logintoken}"  rel="nofollow">账号管理</a></p>
                                    <p><a href="/memberAddr?logintoken=${logintoken}"  rel="nofollow">地址管理</a></p>
                            ...
                            <li class=""><a href="/StoreChart?logintoken=${logintoken}"  rel="nofollow">我的销量</a></li>
                        </ul>
                </div>
            </header>
