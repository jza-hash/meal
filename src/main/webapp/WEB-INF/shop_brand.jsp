...
<head>
    ...
    <meta name="description" content="外卖超人，全球领先订餐平台。超过万余家餐厅为您实时提供在线外卖订餐服务.中餐,快餐,西餐,茶点,各色料理,助您本地美食全搜罗!无需注册!网上订餐首选外卖超人!" />
    	...
    	$.ajax({
    		...
    		success:function(msg){
    				$.each(msg,function(index,data1){
    					...
    					var obj = eval("("+json+")"); 
        				$("#part").append("<li class='restaurant-item fl'><div class='img-box fl'><a href='/ProductList'><img src='http://dhcrestaurantlogo.dhero.cn/2816?v=1402216533' width='82px' height='82px'></a></div><article class='restaurant-introduce fl'><h3 class='ellipsis'><a href='/ProductList'>"+data1.storename+"</a></h3><dl class='clearfix'><dt class='fl'>饮料小吃</dt><dd class='small-star fl'><div class='small-star score' style='width:52.00px'></div></dd></dl><div class='restaurant-state'><span><img src='http://dhcactivity.dhero.cn/FjnSIEuUzJvV6j-ifPq7zevJSt30?imageView2/1/w/15/h/15/' alt='' /></span></div></article></li>");
        			})
    		}
    	})
    })
                ...
                <div class="common-width clearfix">
                    <h1 class="fl">
                        ...
                        <ul class="member logging" ng-init="loginInfo=true">
                            ...
                            <li class=""><a href="/StoreChart"  rel="nofollow">氪星礼品站</a></li>
    ...
    <section class="common-width">
         <header class="header clearfix back-tan fs14">
            <div class="common-width">
               <a href="javascript:;" class="fl landing-header">附近餐厅</a>
            </div>
        </header>
        
            <div class="landing-banner">
                <img src="/static/images/xianyuxian.jpg" />
            </div>
        ...
        <section class="restaurant-main common-width" lazy-img-load>
            <nav class="mark clearfix">
                    ...
                    <li ng-class="{cur:tabsAction3}" ng-click="tabsAction(3)">休息中</li>
                </ul>
            </nav>
            ...
            <div class="restaurant-list-empty">没有找到餐厅</div>
        </div>
        
        
            <div class="restaurant-list rest" ng-class="{hide:!tabsAction3}">
            <div class="mark fs16" style="display:none;">休息中</div>
            <ul class="clearfix">
