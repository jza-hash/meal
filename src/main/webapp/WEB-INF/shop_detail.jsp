    	...
    	$.ajax({
    		...
    		success:function(msg){
    				$.each(msg,function(index,data1){
    					...
    					//alert(data1);
    					//alert(obj.pid);
        				//$("#part").append("<div class='fl restaurant-msg'><div><img  width='43' height='43' class='fl' /><i class='fl'>"+json.storename+"</i></div><p class='clearfix'><i class='fl'></i><span class='fl'></span></p></div>");
        				$("#part1").append(" <li title='"+data1.name+"' class='menu-item hasImg' accessorykey='"+data1.id+"' data-sale='8' data-price='38.00'><div class='menu-item-img'><img data-src='' src=''  width='202' height='202' /> </div><div class='meun-item-name'><span class='ellipsis'>"+data1.name+"</span></div><p class='ellipsis meun-item-des'></p><div class='meun-item-sale clearfix'><span class='last'></span> <span class='price'>"+data1.money+"</span><span ng-if='menuItemCount["+data1.id+"]' ng-class='{disinbl:menuItemCount['39215-2048899']}' class='badge disnone' ng-bind='menuItemCount['39215-2048898']'></span></div></li>");
                        $("#part1").append("<li title=\"黄油虾仁炒饭\" class=\"menu-item hasImg\" accessorykey=\"39215-2048898\" data-sale=\"8\" data-price=\"38.00\">\n" +
                            "                                        <div class=\"menu-item-img\">\n" +
                            "                                            <img src=\"http://dhcmenuitem.dhero.cn/142615425540822113425540737808?imageView2/1/w/202/h/202/\" src=\"http://dhcmenuitem.dhero.cn/0\"  width=\"202\" height=\"202\" /> \n" +
                            "                                        </div>\n" +
                            ...
                            "                                                  class=\"badge disnone ng-scope ng-binding disinbl\" ng-bind=\"menuItemCount['39215-2048898']\"></span>\n" +
...
<%--    <script type="text/javascript">--%>
<%--        --%>
<%--        (function(document, screen) {if (screen.width < 760) {document.location.href="";}}(document, screen));--%>
<%--    </script>--%>
    
    <link rel="stylesheet" href="/static/css/common.css?v=2015-5-20"/>
    
    <link rel="stylesheet" href="/static/css/menuPage.css?v=2015-5-20"/>
    ...
    <section class="common-back" id="wrapBackground">
            ...
            <header id="header">
                <div class="common-width clearfix">
                    <h1 class="fl">
                        <a class="logo base-logo" href="/getIndex">外卖超人</a>
                    </h1>

                        <ul class="member" login-box>
                            <li><a href="/getIndex" class="index">首页</a></li>
                ...
                <div class="inner-main">
                    ...
                    <nav class="list-order-nav clearfix" id="list-order-nav">
                        <ul class="fl">
                            ...
                            <li><a href="javascript:void(0);" class="sort-sale descend">销量</a></li>
                            <li class="split-line">|</li>
                            <li><a href="javascript:void(0);" class="sort-price">价格升序</a></li>
                            <li class="split-line">|</li>
                            <li><a href="javascript:void(0);" class="sort-price">价格降序</a></li>
                        </ul>
                    </nav>
                    <div id="menu-main" class="menu-main">
                    
                    <article class="collapse section-39215" id="part">
                         <header accordion>
                            <h3 class="ellipsis">今日菜品 </h3>
                        ...
                        <section id="part3">
                            ...
                            <ul class="clearfix menu-group menu-group-img menu-first-load" id="part1">
                                ...
                                <li title="黄油虾仁炒饭" class="menu-item hasImg" accessorykey="39215-2048899" data-sale="8" data-price="38.00">
                                    <div class="menu-item-img">
                                        <img data-src="http://dhcmenuitem.dhero.cn/142615425540822113425540737808?imageView2/1/w/202/h/202/" src="http://dhcmenuitem.dhero.cn/0"  width="202" height="202" />
                                    </div>
                                    <div class="meun-item-name"><span class="ellipsis">测试数据</span></div>
                                    <p class="ellipsis meun-item-des"></p>
                                    <div class="meun-item-sale clearfix">
                                        <span class="last"></span>
                                        <span class="price">￥38.00</span>
                                        <span ng-if="menuItemCount['39215-2048899']" ng-class="{disinbl:menuItemCount['39215-2048899']}"
                                              class="badge disnone" ng-bind="menuItemCount['39215-2048899']"></span>
                                        <span class="fr">已售8份</span>
                                    </div>
                                   </li>
                                </ul>
                    ...
                    <article class="collapse section-189417">
                        ...
                        <section>
                            ...
                            <ul class="clearfix menu-group"  id="part2">
...
<script>
    ...
    <dh-dialog class="disnone" type="alert" index="1001" header="" show="createOrderError">
        <div class="alert-box error">
            <p style="padding-right:20px;">
                <span ng-bind="createOrderErrorMsg"></span><a href="javascript:" title="清空购物车" class="clearShopingCart" ng-show="clearShopCart" >清空购物车</a>
            </p>
        </div>
    </dh-dialog>
    ...
    <script src="/static/js/menupage.js"></script>
